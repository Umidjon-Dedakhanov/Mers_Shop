  ...
  const handleSendMessage = (e) => {
    e.preventDefault();
      ...
      if(dbEmailCheck && dbNameCheck && dbSurnameCheck && dbPhoneCheck){
        setLoading(true);
        authApiInstance.post(CONTACT_MAIN_ENDPOINT, {
          name,
          email,
          surname,
          message,
  ...
  return (
    <div className={style.body}>
      ...
      <form className={style.main} onSubmit={handleSendMessage}>
        ...
        <textarea className={style.message_inp} placeholder="Message" value={message} onChange={e => setMessage(e.target.value)}></textarea>
