    ...
    return (
      <div className={style.main}>
        <form onSubmit={handleUserRegistration}>
            ...
            <input autoFocus id="f_name" type="text" value={fName} onChange={e => setFName(e.target.value)}/>
            <label htmlFor="s_name">Last name *</label>
            <input type="text" id="s_name" value={sName} onChange={e => setSName(e.target.value)}/>
            <label htmlFor="phone"> Phone number *</label>
            <input type="number" id="phone" autoComplete="off" value={phone} onChange={e => setPhone(e.target.value)}/>
            {
                !isValidPhone && phone.length > 0 ? <p className={style.instructor}>Phone number must be in international format</p> : <></>
            }
            ...
            <input type="password" id="password-confirm" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)}/>
            {
                !matched && confirmPassword.length > 0 ? <p className={style.instructor}>Confirm Password is not match!</p> : <></>
            }
